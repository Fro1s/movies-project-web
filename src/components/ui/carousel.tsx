...
interface CarouselStepsProps extends React.HTMLAttributes<HTMLDivElement> {
  size: number;
}
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ref={ref}
      className={cn(
        'h-14 w-14 text-accent cursor-pointer disabled:text-muted-foreground disabled:cursor-not-allowed',
